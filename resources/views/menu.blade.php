      ...
      <div class="info">
        <div class="row no-gutters">
          ...
          <div class="col-md-4 d-flex ftco-animate">
            ...
            <div class="text">
              <h3>Danang</h3>
              <p>459 Ton Duc Thang, Hoa Khanh Nam, Lien Chieu, Danang, Vietnam</p>
            </div>
          </div>
    ...
    <div class="row">
      <div class="col-md-6 mb-5 pb-3">
        ...
        @forelse($desserts as $dessert)
          <div class="pricing-entry d-flex ftco-animate">
            <div class="img" style="background-image: url('{{ $imagePath($dessert->image) }}')"></div>
            <div class="desc pl-3">
              <div class="d-flex text align-items-center">
                <h3><span>{{ $dessert->name }}</span></h3>
                <span class="price">${{ number_format((float) ($dessert->price ?? 0), 2) }}</span>
              </div>
              <div class="d-block">
      ...
      <div class="col-md-6 mb-5 pb-3">
        ...
        @forelse($drinks as $drink)
          <div class="pricing-entry d-flex ftco-animate">
            <div class="img" style="background-image: url('{{ $imagePath($drink->image) }}')"></div>
            <div class="desc pl-3">
              <div class="d-flex text align-items-center">
                <h3><span>{{ $drink->name }}</span></h3>
                <span class="price">${{ number_format((float) ($drink->price ?? 0), 2) }}</span>
              </div>
              <div class="d-block">
      ...
      <div class="col-md-6">
        ...
        @forelse($starters as $starter)
          <div class="pricing-entry d-flex ftco-animate">
            <div class="img" style="background-image: url('{{ $imagePath($starter->image) }}')"></div>
            <div class="desc pl-3">
              <div class="d-flex text align-items-center">
                <h3><span>{{ $starter->name }}</span></h3>
                <span class="price">${{ number_format((float) ($starter->price ?? 0), 2) }}</span>
              </div>
              <div class="d-block">
      ...
      <div class="col-md-6">
        ...
        @forelse($mainDishes as $mainDish)
          <div class="pricing-entry d-flex ftco-animate">
            <div class="img" style="background-image: url('{{ $imagePath($mainDish->image) }}')"></div>
            <div class="desc pl-3">
              <div class="d-flex text align-items-center">
                <h3><span>{{ $mainDish->name }}</span></h3>
                <span class="price">${{ number_format((float) ($mainDish->price ?? 0), 2) }}</span>
              </div>
              <div class="d-block">
        ...
        <div class="row">
          <div class="col-md-12 nav-link-wrap mb-5">
            <div class="nav ftco-animate nav-pills justify-content-center" id="v-pills-tab" role="tablist" aria-orientation="vertical">
              ...
              <a class="nav-link" id="v-pills-4-tab" data-toggle="pill" href="#v-pills-4" role="tab" aria-controls="v-pills-4" aria-selected="false">Starter</a>
              <a class="nav-link" id="v-pills-5-tab" data-toggle="pill" href="#v-pills-5" role="tab" aria-controls="v-pills-5" aria-selected="false">Main Dish</a>
            </div>
          </div>
                ...
                <div class="row">
                  @forelse($coffees as $coffee)
                    <div class="col-md-4 text-center">
                      <div class="menu-wrap">
                        <a href="{{ url('/products/' . $coffee->id) }}" class="menu-img img mb-4"
                           style="background-image: url('{{ $imagePath($coffee->image) }}')"></a>
                        <div class="text">
                          <h3 class="text-dark"><a href="{{ url('/products/' . $coffee->id) }}">{{ $coffee->name }}</a></h3>
                          <p>{{ $coffee->description }}</p>
                          <p class="price"><span>${{ number_format((float) ($coffee->price ?? 0), 2) }}</span></p>
                          <p><a href="{{ url('/products/' . $coffee->id) }}" class="btn btn-primary btn-outline-primary">Show</a></p>
              ...
              <div class="tab-pane fade" id="v-pills-2" role="tabpanel" aria-labelledby="v-pills-2-tab">
                <div class="row">
                  @forelse($drinks as $drink)
                    <div class="col-md-4 text-center">
                      <div class="menu-wrap">
                        <a href="{{ url('/products/' . $drink->id) }}" class="menu-img img mb-4"
                           style="background-image: url('{{ $imagePath($drink->image) }}')"></a>
                        <div class="text">
                          <h3 class="text-dark"><a href="{{ url('/products/' . $drink->id) }}">{{ $drink->name }}</a></h3>
                          <p>{{ $drink->description }}</p>
                          <p class="price"><span>${{ number_format((float) ($drink->price ?? 0), 2) }}</span></p>
                          <p><a href="{{ url('/products/' . $drink->id) }}" class="btn btn-primary btn-outline-primary">Show</a></p>
                          <form action="{{ route('cart.add', $drink->id) }}" method="POST" class="mt-2">
                            @csrf
                            <input type="hidden" name="quantity" value="1">
                            <button type="submit" class="btn btn-primary btn-sm">Add to Cart</button>
              ...
              <div class="tab-pane fade" id="v-pills-3" role="tabpanel" aria-labelledby="v-pills-3-tab">
                <div class="row">
                  @forelse($desserts as $dessert)
                    <div class="col-md-4 text-center">
                      <div class="menu-wrap">
                        <a href="{{ url('/products/' . $dessert->id) }}" class="menu-img img mb-4"
                           style="background-image: url('{{ $imagePath($dessert->image) }}')"></a>
                        <div class="text">
                          <h3 class="text-dark"><a href="{{ url('/products/' . $dessert->id) }}">{{ $dessert->name }}</a></h3>
                          <p>{{ $dessert->description }}</p>
                          <p class="price"><span>${{ number_format((float) ($dessert->price ?? 0), 2) }}</span></p>
                          <p><a href="{{ url('/products/' . $dessert->id) }}" class="btn btn-primary btn-outline-primary">Show</a></p>
                          <form action="{{ route('cart.add', $dessert->id) }}" method="POST" class="mt-2">
                            @csrf
                            <input type="hidden" name="quantity" value="1">
                            <button type="submit" class="btn btn-primary btn-sm">Add to Cart</button>
              ...
              <div class="tab-pane fade" id="v-pills-4" role="tabpanel" aria-labelledby="v-pills-4-tab">
                <div class="row">
                  @forelse($starters as $starter)
                    <div class="col-md-4 text-center">
                      <div class="menu-wrap">
                        <a href="{{ url('/products/' . $starter->id) }}" class="menu-img img mb-4"
                           style="background-image: url('{{ $imagePath($starter->image) }}')"></a>
                        <div class="text">
                          <h3 class="text-dark"><a href="{{ url('/products/' . $starter->id) }}">{{ $starter->name }}</a></h3>
                          <p>{{ $starter->description }}</p>
                          <p class="price"><span>${{ number_format((float) ($starter->price ?? 0), 2) }}</span></p>
                          <p><a href="{{ url('/products/' . $starter->id) }}" class="btn btn-primary btn-outline-primary">Show</a></p>
                          <form action="{{ route('cart.add', $starter->id) }}" method="POST" class="mt-2">
                            @csrf
                            <input type="hidden" name="quantity" value="1">
                            <button type="submit" class="btn btn-primary btn-sm">Add to Cart</button>
              ...
              <div class="tab-pane fade" id="v-pills-5" role="tabpanel" aria-labelledby="v-pills-5-tab">
                <div class="row">
                  @forelse($mainDishes as $mainDish)
                    <div class="col-md-4 text-center">
                      <div class="menu-wrap">
                        <a href="{{ url('/products/' . $mainDish->id) }}" class="menu-img img mb-4"
                           style="background-image: url('{{ $imagePath($mainDish->image) }}')"></a>
                        <div class="text">
                          <h3 class="text-dark"><a href="{{ url('/products/' . $mainDish->id) }}">{{ $mainDish->name }}</a></h3>
                          <p>{{ $mainDish->description }}</p>
                          <p class="price"><span>${{ number_format((float) ($mainDish->price ?? 0), 2) }}</span></p>
                          <p><a href="{{ url('/products/' . $mainDish->id) }}" class="btn btn-primary btn-outline-primary">Show</a></p>
                          <form action="{{ route('cart.add', $mainDish->id) }}" method="POST" class="mt-2">
                            @csrf
                            <input type="hidden" name="quantity" value="1">
                            <button type="submit" class="btn btn-primary btn-sm">Add to Cart</button>
